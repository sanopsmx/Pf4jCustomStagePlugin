...
@TestPropertySource(properties = [
  "spinnaker.extensibility.plugins.Armory.CustomStagePlugin.enabled=true",
...
class OrcaPluginsFixture : OrcaFixture() {
  ...
  init {
    val pluginId = "Armory.CustomStagePlugin"
    ...
    PluginJar.Builder(plugins.toPath().resolve("$pluginId.jar"), pluginId)
      .pluginClass(CustomStagePlugin::class.java.name)
      .pluginVersion("1.0.0")
      .manifestAttribute("Plugin-Requires", "orca>=0.0.0")
      .extensions(mutableListOf(CustomStageStage::class.java.name, CustomStageTask::class.java.name))
      .build()
  }
}
